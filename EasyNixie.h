...
class EasyNixie{
    ...
    **/
    ...
    /** @brief This is a custom implementation of ShiftOut function that fits 74HC595 timing specs. If you use vanilla shiftOut the
     * EasyNixie may not work with some faster MCUs(like Esp32-S3).
    **/
